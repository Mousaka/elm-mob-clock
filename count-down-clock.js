...
var _user$project$Clock$displayTimer = function (displayableTime) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg$text(displayableTime),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$ParticipantQueue$update = F2(
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p3.ctor) {
				case 'EnterPress':
					var _v3 = _user$project$ParticipantQueue$Add(
...
var _user$project$Main$keyStrokesDispatcher = _elm_lang$keyboard$Keyboard$downs(_user$project$Main$KeyDown);
				...
				if (_p3 === 13) {
					...
					if (_p4.ctor === 'TheClock') {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{queue: newParticipantQueue}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$Queue, clockCmds)
						};
					}
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
