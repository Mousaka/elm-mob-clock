...
var _user$project$Styling$flexMiddle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'display', _1: 'flex'},
		_1: {
...
var _user$project$Styling$notSelectedStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'font-size', _1: '14pt'},
		_1: {
			ctor: '::',
...
var _user$project$Styling$selectedStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'font-size', _1: '16pt'},
		_1: {
			ctor: '::',
...
var _user$project$Util$numSlicer = function (textTime) {
	var sec = A2(_elm_lang$core$String$right, 2, textTime);
	var mins = A3(_elm_lang$core$String$slice, -4, -2, textTime);
	var minSec = {
		ctor: '_Tuple2',
		_0: _user$project$Util$toParsedTime(mins),
		_1: _user$project$Util$toParsedTime(sec)
	};
	var _p1 = minSec;
	_v1_2:
	do {
		if (_p1.ctor === '_Tuple2') {
			if (_p1._0.ctor === 'Nothing') {
				...
				if (_p1._1.ctor === 'Just') {
					return _elm_lang$core$Maybe$Just((60 * _p1._0._0) + _p1._1._0);
				} else {
					break _v1_2;
				}
			}
...
var _user$project$Util$removeNonNumerals = _elm_lang$core$String$filter(_elm_lang$core$Char$isDigit);
var _user$project$Util$toMinSec = function (textTime) {
...
var _user$project$Clock$clock = function (time) {
	...
	var secondHandlerTip = {
		...
		_1: 50 + (40 * _elm_lang$core$Basics$sin(secondsAngle))
	};
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$Clock$clockHandle, minutesHandlerTip, '#000000'),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Clock$clockHandle, secondHandlerTip, '#F0F8FF'),
					_1: {ctor: '[]'}
				}
			}
		});
	...
	return A2(
		...
		},
		{
			...
			_0: _elm_lang$svg$Svg$text(
				_user$project$Clock$displayTime(displayableTime)),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Clock$Model = F4(
	function (a, b, c, d) {
		return {time: a, resetTime: b, clockState: c, timeInput: d};
	});
...
var _user$project$Clock$init = {time: 60 * 10, resetTime: 60 * 10, clockState: _user$project$Clock$Stopped, timeInput: _elm_lang$core$Maybe$Nothing};
var _user$project$Clock$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$Clock$SetTimer = function (a) {
	return {ctor: 'SetTimer', _0: a};
};
var _user$project$Clock$timerInput = F2(
	function (timeInput, currentTime) {
		return A2(
			_elm_lang$html$Html$input,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$placeholder(
					_user$project$Clock$displayTime(currentTime)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(
						A2(_elm_lang$core$Maybe$withDefault, '', timeInput)),
					_1: {
						ctor: '::',
...
var _user$project$Clock$inputOrDisplayTime = function (model) {
	var _p3 = model.clockState;
	switch (_p3.ctor) {
		case 'Paused':
			return _user$project$Clock$displayTimer(model.time);
		case 'Running':
			return _user$project$Clock$displayTimer(model.time);
		default:
			return A2(_user$project$Clock$timerInput, model.timeInput, model.time);
	}
};
...
var _user$project$Clock$handleKeyPress = F2(
	function (model, keyCode) {
		var numberKeys = {
			ctor: '::',
			_0: _ohanhi$keyboard_extra$Keyboard_Extra$Number0,
			_1: {
				ctor: '::',
				_0: _ohanhi$keyboard_extra$Keyboard_Extra$Number1,
				_1: {
					ctor: '::',
					_0: _ohanhi$keyboard_extra$Keyboard_Extra$Number2,
					_1: {
						ctor: '::',
						_0: _ohanhi$keyboard_extra$Keyboard_Extra$Number3,
						_1: {
							ctor: '::',
							_0: _ohanhi$keyboard_extra$Keyboard_Extra$Number4,
							_1: {
								ctor: '::',
								_0: _ohanhi$keyboard_extra$Keyboard_Extra$Number5,
								_1: {
									ctor: '::',
									_0: _ohanhi$keyboard_extra$Keyboard_Extra$Number6,
									_1: {
										ctor: '::',
										_0: _ohanhi$keyboard_extra$Keyboard_Extra$Number7,
										_1: {
											ctor: '::',
											_0: _ohanhi$keyboard_extra$Keyboard_Extra$Number8,
											_1: {
												ctor: '::',
												_0: _ohanhi$keyboard_extra$Keyboard_Extra$Number9,
												_1: {ctor: '[]'}
											}
										}
									}
		...
		var _p5 = _ohanhi$keyboard_extra$Keyboard_Extra$fromCode(keyCode);
		if (_p5.ctor === 'CharS') {
			var _p6 = model.clockState;
			switch (_p6.ctor) {
				case 'Stopped':
					return A2(_user$project$Clock$update, _user$project$Clock$Start, model);
				case 'Running':
					return A2(_user$project$Clock$update, _user$project$Clock$Pause, model);
				case 'Paused':
					return A2(_user$project$Clock$update, _user$project$Clock$Start, model);
				default:
					return A2(_user$project$Clock$update, _user$project$Clock$Reset, model);
			}
		} else {
			if (A2(_elm_lang$core$List$member, _p5, numberKeys)) {
				var updateTimer = A2(
					_user$project$Clock$update,
					_user$project$Clock$SetTimer(
						A2(
							_elm_lang$core$Basics_ops['++'],
							A2(_elm_lang$core$Maybe$withDefault, '', model.timeInput),
							_elm_lang$core$Basics$toString(
								_ohanhi$keyboard_extra$Keyboard_Extra$fromCode(keyCode)))),
					model);
				var _p7 = model.clockState;
				switch (_p7.ctor) {
					case 'Stopped':
						return updateTimer;
					case 'Running':
...
var _user$project$Clock$update = F2(
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p8.ctor) {
				case 'KeyDown':
					return A2(_user$project$Clock$handleKeyPress, model, _p8._0);
				case 'Tick':
					var _p9 = model.time;
					switch (_p9) {
						case 1:
							var _v9 = _user$project$Clock$SoundAlarm,
				...
				case 'Start':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{clockState: _user$project$Clock$Running, timeInput: _elm_lang$core$Maybe$Nothing}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Reset':
					return {
				...
				default:
					var _p11 = _user$project$Util$toMinSec(_p8._0);
					if (_p11.ctor === 'Just') {
						var _p12 = _p11._0;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									resetTime: _p12,
									time: _p12,
									timeInput: _elm_lang$core$Maybe$Just(
										_user$project$Clock$displayTime(_p12))
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
...
var _user$project$Clock$view = function (model) {
	...
	var timeField = _user$project$Clock$inputOrDisplayTime(model);
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Styling$flexMiddle,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg$text(message),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Clock$subscriptions = function (model) {
	var keySub = _elm_lang$keyboard$Keyboard$downs(_user$project$Clock$KeyDown);
	var timeSub = function () {
		var _p14 = model.clockState;
		if (_p14.ctor === 'Running') {
...
var _user$project$ParticipantQueue$validInput = function (text) {
	return (_elm_lang$core$Native_Utils.cmp(
		...
		0) > 0) ? _elm_lang$core$Maybe$Just(text) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$ParticipantQueue$displayOneParticipant = function (participant) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Styling$notSelectedStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(participant),
			_1: {ctor: '[]'}
		});
};
var _user$project$ParticipantQueue$displaySelected = function (participant) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Styling$selectedStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$ParticipantQueue$displayParticipants = function (participants) {
	...
	if (_p0.ctor === '::') {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$ParticipantQueue$displaySelected(_p0._0),
				_1: A2(_elm_lang$core$List$map, _user$project$ParticipantQueue$displayOneParticipant, _p0._1)
			});
	} else {
		return A2(
			_elm_lang$html$Html$div,
...
var _user$project$ParticipantQueue$rotateQueue = function (participants) {
	...
	var head = _p1._0;
	var tail = _p1._1;
	var _p2 = {ctor: '_Tuple2', _0: head, _1: tail};
...
var _user$project$ParticipantQueue$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$ParticipantQueue$subscriptions = function (model) {
	return _elm_lang$keyboard$Keyboard$downs(_user$project$ParticipantQueue$KeyDown);
};
...
var _user$project$ParticipantQueue$nextButton = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(_user$project$ParticipantQueue$Next),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$ParticipantQueue$rotate = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 90 90'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width('35px'),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$height('35px'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$ParticipantQueue$Next),
							_1: {ctor: '[]'}
					...
					_elm_lang$svg$Svg$circle,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$stroke('#0B79CE'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$strokeWidth('18'),
										_1: {
											ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$x('13'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$y('26'),
									_1: {
										ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$x('68'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$y('55'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$width('20'),
											_1: {
...
var _user$project$ParticipantQueue$nameInput = function (fieldText) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
		...
		while (true) {
			...
			switch (_p3.ctor) {
				case 'KeyDown':
					var _p4 = _p3._0;
					if (_p4 === 13) {
						var _v4 = _user$project$ParticipantQueue$Add(
							_user$project$ParticipantQueue$validInput(model.fieldText)),
							_v5 = model;
						msg = _v4;
						model = _v5;
						continue update;
				...
				case 'Add':
					...
					if (_p5.ctor === 'Just') {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{participants: participants_, fieldText: ''}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$ParticipantQueue$add = function (fieldText) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$svg$Svg$svg,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$width('30px'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$height('30px'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$ParticipantQueue$Add(
										_user$project$ParticipantQueue$validInput(fieldText))),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$ParticipantQueue$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Styling$mediumText,
			_1: {
				ctor: '::',
				_0: _user$project$Styling$fromBottom,
				_1: {ctor: '[]'}
			}
		},
		{
			ctor: '::',
			_0: _user$project$ParticipantQueue$displayParticipants(model.participants),
			_1: {
				ctor: '::',
				_0: _user$project$ParticipantQueue$rotate,
				_1: {
					ctor: '::',
					_0: _user$project$ParticipantQueue$nameInput(model.fieldText),
					_1: {
						ctor: '::',
						_0: _user$project$ParticipantQueue$add(model.fieldText),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$ParticipantQueue$main = _elm_lang$html$Html$program(
	{
		init: A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
